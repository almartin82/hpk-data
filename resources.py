...
#### START/END YEARS ####
yr_2018 = [date(2018, 3, 29), date.today()]                
yr_2017 = [date(2017, 4, 3), date(2017, 10, 1)]
yr_2016 = [date(2016, 4, 3), date(2016, 10, 2)]
yr_2015 = [date(2015, 4, 5), date(2015, 10, 4)]
yr_2014 = [date(2014, 3, 22), date(2014, 9, 28)]
yr_2013 = [date(2013, 4, 1), date(2013, 9, 29)]
